...
public final class LaunchDetailQueryQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query LaunchDetailQuery($id: ID!) {
      launch(id: $id) {
        __typename
        details
        launch_date_local
  ...
  public let operationName: String = "LaunchDetailQuery"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Launch: GraphQLSelectionSet {
      ...
      public init(details: String? = nil, launchDateLocal: String? = nil, launchSite: LaunchSite? = nil, launchSuccess: Bool? = nil, missionName: String? = nil, rocket: Rocket? = nil, ships: [Ship?]? = nil, links: Link? = nil, id: GraphQLID? = nil) {
        self.init(unsafeResultMap: ["__typename": "Launch", "details": details, "launch_date_local": launchDateLocal, "launch_site": launchSite.flatMap { (value: LaunchSite) -> ResultMap in value.resultMap }, "launch_success": launchSuccess, "mission_name": missionName, "rocket": rocket.flatMap { (value: Rocket) -> ResultMap in value.resultMap }, "ships": ships.flatMap { (value: [Ship?]) -> [ResultMap?] in value.map { (value: Ship?) -> ResultMap? in value.flatMap { (value: Ship) -> ResultMap in value.resultMap } } }, "links": links.flatMap { (value: Link) -> ResultMap in value.resultMap }, "id": id])
      }
      ...
      public struct Ship: GraphQLSelectionSet {
        ...
        public init(name: String? = nil, image: String? = nil) {
          self.init(unsafeResultMap: ["__typename": "Ship", "name": name, "image": image])
        }
...
public final class LaunchesQueryQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationName: String = "LaunchesQuery"
  ...
  public init(limit: Int? = nil, offset: Int? = nil, sort: String? = nil, order: String? = nil) {
    self.limit = limit
    self.offset = offset
    self.sort = sort
    self.order = order
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("launches", arguments: ["limit": GraphQLVariable("limit"), "offset": GraphQLVariable("offset"), "sort": GraphQLVariable("sort"), "order": GraphQLVariable("order")], type: .list(.object(Launch.selections))),
      ]
    }
    ...
    public struct Launch: GraphQLSelectionSet {
      ...
      public init(missionName: String? = nil, rocket: Rocket? = nil, id: GraphQLID? = nil, launchDateLocal: String? = nil) {
        self.init(unsafeResultMap: ["__typename": "Launch", "mission_name": missionName, "rocket": rocket.flatMap { (value: Rocket) -> ResultMap in value.resultMap }, "id": id, "launch_date_local": launchDateLocal])
      }
